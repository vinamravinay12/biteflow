    ...
    >
      ...
      {showCart && (
        <CartDrawer
          ...
          setTempStandName={setTempStandName}
          setTempSeatNumber={setTempSeatNumber}
        />
      )}
      ...
      {showSeatMapModal && (
        <SeatMapModal
          language={language}
          tempStandName={tempStandName}
          tempSeatNumber={tempSeatNumber}
          onSelectStand={setTempStandName}
          onSelectSeat={setTempSeatNumber}
          onConfirm={() => {
